...
export default function PageHero({
  ...
  return (
    <section className="relative w-full min-h-[70vh] flex bg-[#1a0505] overflow-hidden pt-0 pb-24 lg:pb-32">
      ...
      <div className="absolute inset-y-0 right-0 w-full lg:w-[65%] z-0">
        ...
        <div className="absolute top-6 right-6 lg:top-12 lg:right-12 pointer-events-none select-none opacity-40 z-10">
          <p className="text-white font-black text-2xl md:text-3xl lg:text-4xl uppercase tracking-[0.2em] text-right max-w-sm leading-tight drop-shadow-md">
      ...
      <div className="container-inner relative z-10 w-full">
        <div className="max-w-[1000px] text-white pt-4 lg:pt-4">
          <p className="font-bold tracking-widest uppercase mb-6 text-xs md:text-sm flex items-center gap-3">
          ...
          <h1 
            className="h-display mb-12 relative z-10" 
          ...
          <p className="text-base md:text-lg font-medium text-white/90 mb-10 max-w-3xl leading-relaxed relative z-10 mt-6">
            {description}
          </p>
